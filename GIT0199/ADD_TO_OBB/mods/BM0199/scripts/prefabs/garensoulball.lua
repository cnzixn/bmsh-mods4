...
local function OnHit(inst, owner, target)
    ...
    then
        ...
        target:Remove()
    elseif target:HasTag("bird") then
        clearFollower(inst)
        inst:Remove()
    end
end
...
local function onpreload(inst, data)
    ...
    if data.creaturename then
        ...
        inst.creaturename = "garensoulball"
    end
    inst.name = inst.creaturename
...
local function onsave(inst, data)
    ...
    if inst.creaturename then
        ...
        data.creaturename = "garensoulball"
    end
...
local function OnDrop(inst)
    ...
    if inst and inst.sealcreature and inst.sealcreature ~= 0 then
        ...
        instcreature.prefab = 'garensoulball'
...
return Prefab("common/inventory/garensoulball", fn, assets, prefabs)
