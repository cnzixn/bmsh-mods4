...
local Garen_buffer_saver = Class(function(self, inst)
    self.inst = inst
...
local CHAR = "garen"
function Garen_buffer_saver:OnSave()
...
function Garen_buffer_saver:OnLoad(data)
...
function Garen_buffer_saver:loop()
